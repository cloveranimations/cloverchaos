...
const chapters = [
  ...
  { chapter: 'Chapter 5: Taradiddle', text: 'Mark evades the authority and escapes to his hideout. Pat comes back to Montreal after 10 months. Stumbles across the old run down building and gets chased by Mark\'s drones. He gets saved by Charles "Micheal" McCallister — the former agent — and Velma, on the hunt for answers as it is the first time they appear since Delta One, the spinoff film. All three hunt Mark\'s hideout until they stumble across his Headquarters, which former agent McCallister thought was a myth. They invade and Pat gets caught by Mark Heffley himself. Valentina is locked in the room as well. For a search for answers, Mark tries to see into the future of the Eclipse Project — the Stargazer was just a mere act and test for the Eclipse Project — by forcing a headset plugged to a screen.' },
];
