      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '140px 20px 100px', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', background: 'transparent', color: '#4ade80', fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', padding: '14px 40px', borderRadius: '8px', textDecoration: 'none', border: '2px solid rgba(74,222,128,0.4)', marginTop: '16px', transition: 'all 0.2s ease' }}
