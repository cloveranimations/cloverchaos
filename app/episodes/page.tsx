...
const episodes = [
  ...
  { num: '05', title: 'Taradiddle', desc: 'Phase two starts with a bang when Pat revisits ground zero of their old building. Gloom fills the air until he stumbles upon something more than just coordinates. He must assemble a crew not like the one before it. He is just too clueless to understand.', duration: '13:06', tags: ['PHASE 2', 'ADVENTURE'], url: 'https://youtu.be/R8kc1_Nusrs', thumbnail: 'https://i.imgur.com/NQqfJpj.png' },
