...
const episodes = [
  ...
  { num: '05', title: 'Taradiddle', desc: 'Pat returns to Montreal after 10 months and stumbles upon the old building, getting chased by Mark\'s drones. Saved by former agent McCallister and Velma, the trio hunts down Mark\'s mythical headquarters — only for Pat and Valentina to be captured by Mark himself.', duration: '13:06', tags: ['PHASE 2', 'ADVENTURE'], url: 'https://youtu.be/R8kc1_Nusrs', thumbnail: 'https://i.imgur.com/NQqfJpj.png' },
