...
const episodes = [
  ...
  { num: '05', title: '█████████████', desc: 'Phase 2 begins. ████████ forces Pat and the team to ████████ in ways they never anticipated. A familiar face ██████████, and the truth behind ████████████ starts to ████████ itself. The rules have changed — and so has ████████.', duration: '--:--', tags: ['PHASE 2', 'COMING SOON'], url: '', thumbnail: 'https://i.imgur.com/MzqfAE6.png' },
];
