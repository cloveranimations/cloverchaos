        ...
        <div style={{ maxWidth: '1000px', textAlign: 'center' }}>
          ...
          <AnimatedElement delay={0.4}>
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap', marginTop: '28px' }}>
              ...
              <a href="https://www.etsy.com/shop/CloverChaosDesigns?ref=seller-platform-mcnav" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Shop Now</a>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
          <AnimatedElement>
            <div style={{ marginBottom: '64px', textAlign: 'center' }}>
              <h2 style={{ fontSize: 'clamp(36px, 5vw, 72px)', fontFamily: 'var(--font-display)', fontWeight: '700', color: '#4ade80' }}>Episodes</h2>
            </div>
          </AnimatedElement>
                ...
                >
                  ...
                  <div style={{ position: 'relative', zIndex: 3, padding: '16px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '8px', borderTop: '1px solid rgba(167,139,250,0.15)', fontSize: '11px', color: '#64748b' }}>
                      <span>{ep.duration}</span>
                      {ep.url ? (
                        <a href={ep.url} target="_blank" rel="noopener noreferrer" style={{ color: '#a78bfa', textDecoration: 'none', fontSize: '11px' }}>&#9654; Watch</a>
                      ) : (
                        <span style={{ color: '#64748b', fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '1px' }}>COMING SOON</span>
                      )}
                    </div>
